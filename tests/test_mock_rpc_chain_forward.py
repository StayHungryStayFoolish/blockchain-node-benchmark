#!/usr/bin/env python3
"""L1: mock_rpc_server.handle_evm eth_getBlockByHash forwards chain param.

Round-05 P2 fix: defensive — verifies chain kwarg propagates through the
recursive call so future chain-specific block fields (BSC/Polygon/Base)
won't silently default to ethereum.
"""
import sys
import unittest
