#!/usr/bin/env python3
"""Unit test guards for mock_rpc_server.py v1.4.4 bug fixes.

Bugs found in S2 audit (2026-05-21):
...
Run: python3 tests/test_mock_rpc_server_v144_fixes.py
"""
import sys
import unittest
...
class TestBackwardCompat(unittest.TestCase):
    """Smoke: all 8 chains can still dispatch their bread-and-butter methods."""
