#!/usr/bin/env python3
"""
test_k8s_monitoring_stack.py - unit tests for the K8s client stack
==========================================================
...
zero kind or docker requirement.

Run: python3 tests/test_k8s_monitoring_stack.py
"""
...
class TestK8sApiClient(unittest.TestCase):
    ...
    def test_token_from_env(self):
        ...
        try:
            ...
            # Token storage is lazy-reread to lazy reread (rotation-safe).
...
class TestCSIExtractors(unittest.TestCase):
    ...
    def test_generic_csi_falls_back_to_volume_handle(self):
        """generic CSI returns "?" (not raw handle).
