...
# Configuration content: provider parameters, log configuration, advanced bottleneck detection thresholds
# Modification frequency: Occasionally modified
# =====================================================================

# ----- Deployment Platform Detection Configuration -----
# Deployment platform type (auto: auto-detect, gcp: Google Cloud, aws: AWS, other: other environments)
...
export MONITORING_PROCESS_NAMES DEPLOYMENT_PLATFORM
