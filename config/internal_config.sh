...
# 区块高度差异阈值
BLOCK_HEIGHT_DIFF_THRESHOLD=500
# 区块高度时间阈值 (秒)
BLOCK_HEIGHT_TIME_THRESHOLD=600
# 区块高度监控间隔 (秒)
BLOCK_HEIGHT_MONITOR_INTERVAL=10
...
export BLOCK_HEIGHT_DIFF_THRESHOLD BLOCK_HEIGHT_TIME_THRESHOLD BLOCK_HEIGHT_MONITOR_INTERVAL
