#!/usr/bin/env bash
# gcp_gke_setup.sh — One-shot GKE test cluster setup for Mode E validation
#
# Reproduces the GCP/GKE environment from scratch:
...
#
# Usage:
#   PROJECT=my-gcp-project bash scripts/gcp_gke_setup.sh
#
# Prereqs:
